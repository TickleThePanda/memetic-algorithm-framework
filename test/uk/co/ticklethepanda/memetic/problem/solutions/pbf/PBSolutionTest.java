...
public class PBSolutionTest {
  ...
  public void Equals_DifferentType_False() {
    final BitString sol = new BitString(new boolean[] { true, false, false, true, true }, function);
  ...
  public void Equals_Equal_True() {
    final BitString sol1 =
        new BitString(new boolean[] { true, false, false, true, true }, function);
  ...
  public void Equals_SameTypeNotEqual_False() {
    final BitString sol1 =
        new BitString(new boolean[] { false, false, false, true, true }, function);
  ...
  public void FlipBit_Bit4_CorrectBit() {
    ...
    final BitString expected =
        new BitString(new boolean[] { true, true, true, false, true }, function);
  ...
  public void getActualValue_randomSolution_correctValue() {
    final BitString bitString = new BitString(PbTestHelper.createRandomBoolArr(randomSize), function);
    assertEquals(function.actualValue(bitString), bitString.getObjectiveValue());
  }
  ...
  public void TestComparator_DifferentItem_ReturnDiff() {
    ...
    final BitString bfDiff = new BitString(new boolean[] { false, true, true, false }, function);
  ...
  public void TestComparator_DiffSizeSameItems_DiffLength() {
    ...
    final BitString bfDiff =
        new BitString(new boolean[] { true, false, false, true, false, false }, function);
  ...
  public void TestComparator_RandomValues_ReturnDiff() {
    ...
    final boolean[] bools = PbTestHelper.createRandomBoolArr(randomSize);
    final boolean[] bools2 = PbTestHelper.createRandomBoolArr(randomSize2);
  ...
  public void TestComparator_SameItem_NoDiff() {
    final BitString bfOriginal =
        new BitString(new boolean[] { true, false, false, true }, function);
    final BitString bfSame = new BitString(new boolean[] { true, false, false, true }, function);
  ...
  public void TestGet_GetRandomOutOfRange_OutOfBounds() {
    ...
    try {
      ...
      assertEquals(e.getMessage(), "Index " + randomValue + " is out of bounds!");
      return;
    }
    fail("exception was not thrown");
  }
  ...
  public void TestMutate_RandomSeed_CorrectMutation() {
    ...
    final boolean[] testBools = PbTestHelper.createRandomBoolArr(solutionSize);
  ...
  public void TestMutate_RandomValueInRange_SolutionMutated() {
    ...
    final boolean[] testBools = PbTestHelper.createRandomBoolArr(boolSize);
    ...
    final BitString bfMutated = new BitString(testBools2, function).getMutated();
  ...
  public void TestMutate_TestItemMutated_SolutionMutated() {
    final BitString bfOriginal =
        new BitString(new boolean[] { true, false, false, true }, function);
    final BitString bfMutated = new BitString(new boolean[] { true, false, false, true }, function);
