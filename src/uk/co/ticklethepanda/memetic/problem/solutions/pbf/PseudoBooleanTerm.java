...
public class PseudoBooleanTerm implements Iterable<PsuedoBooleanIndeterminant> {
   ...
   */
  private final class BooleanIndeterminantIterator implements Iterator<PsuedoBooleanIndeterminant> {
   ...
   *          the indeterminants
   */
  public PseudoBooleanTerm(final int coefficient,
      final PsuedoBooleanIndeterminant[] indeterminants) {
    ...
    psuedoBooleanIndeterminants = indeterminants;
  }
  ...
  public boolean hasCorrectLocations(final BitString bitString) {
    for (final PsuedoBooleanIndeterminant booleanOperation : psuedoBooleanIndeterminants) {
      if (bitString.get(booleanOperation.getIndex()) == booleanOperation.getExpectedValue()) {
        return false;
      }
    }
    return true;
  ...
  public String toString() {
    final int maxLen = 3;
    return "Term [modifier=" + coefficient + ", booleanOperations="
