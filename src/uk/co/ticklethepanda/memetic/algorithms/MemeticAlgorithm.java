 ...
 * {@link uk.co.ticklethepanda.memetic.algorithms.GeneticAlgorithm GeneticAlgorithm}. It is one of
 * the core classes of this project. It optimises a solution including local improvement.
 *
 * @param <E>
 *          The type of solution that the algorithm improves.
 */
public class MemeticAlgorithm<E extends Solution<E>> extends GeneticAlgorithm<E> {
   ...
   * the {@link uk.co.ticklethepanda.memetic.problem.solutions.LocalImprovement LocalImprovement}.
   *
   * @param settings
  ...
  public MemeticAlgorithm(final EvoAlgorithmSettings settings,
      final Solution.Generator<E> solutionFactory, final LocalImprovement<E> localImprovement) {
  ...
  public MemeticAlgorithm(final Solution.Generator<E> solutionFactory,
    ...
    this(EvoAlgorithmSettings.DEFAULT_SETTINGS_TSP, solutionFactory, localImprovement);
  }
   ...
   * {@link uk.co.ticklethepanda.memetic.problem.solutions.LocalImprovement LocalImprovement}
   * provided.
   */
  public void doImprovements() {
    final ArrayList<E> improvedPool = new ArrayList<E>();
    for (int i = 0; i < super.getSettings().getPoolSize(); i++) {
      improvedPool.add(this.localImprovement.getImprovedSolution(super.population.get(i)));
    }
    super.population = improvedPool;
  }

  /**
   * Get the local {@link uk.co.ticklethepanda.memetic.problem.solutions.LocalImprovement
