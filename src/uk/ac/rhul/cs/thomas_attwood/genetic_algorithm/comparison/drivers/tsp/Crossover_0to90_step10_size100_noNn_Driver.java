...
public final class Crossover_0to90_step10_size100_noNn_Driver {

  private Crossover_0to90_step10_size100_noNn_Driver() {
  }
  ...
  public static void main(final String[] args) {
    ...
    final ThreadedAlgorithms tar =
        new ThreadedAlgorithms(logger, algorithmList, N_THREADS, "output/tsp-crossover-0to90-step1-size100-noNn.csv");
    try {
      tar.run();
    } catch (IOException e) {
      e.printStackTrace();
