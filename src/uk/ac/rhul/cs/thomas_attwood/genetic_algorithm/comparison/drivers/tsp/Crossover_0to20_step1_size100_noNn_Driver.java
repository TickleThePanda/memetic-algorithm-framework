...
public final class Crossover_0to20_step1_size100_noNn_Driver {

  private Crossover_0to20_step1_size100_noNn_Driver() {
  }
  ...
  public static void main(final String[] args) {
    ...
    final ThreadedAlgorithms tar =
        new ThreadedAlgorithms(logger, algorithmList, N_THREADS, "output/tsp-crossover-0to20-step10-size100-noNn.csv");
    try {
      tar.run();
    } catch (IOException e) {
      e.printStackTrace();
  ...
  protected static final int STEP_SIZE = 0;
