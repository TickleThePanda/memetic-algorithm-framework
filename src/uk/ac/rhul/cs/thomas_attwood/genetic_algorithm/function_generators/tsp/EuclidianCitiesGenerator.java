package uk.ac.rhul.cs.thomas_attwood.genetic_algorithm.function_generators.tsp;
 ...
 *
 */
public class EuclidianCitiesGenerator implements
    ProblemGenerator<Tour, Cities<Euclidian>> {
  ...
  public Cities<Euclidian> generateFunction() {
    ...
    for (int i = 0; i < cities.length; i++) {
      cities[i] =
          new Euclidian(random.nextInt(MAX_CITY_VALUES),
              random.nextInt(MAX_CITY_VALUES));
    }

    final Cities<Euclidian> function = new Cities<Euclidian>(cities);
