 ...
 *
 */
public class TspLiSwap implements LocalImprovement<TspTour> {
	 ...
	 */
	public TspLiSwap(final LocalImprovementType type) {
		this.type = type;
	}
	...
	public TspTour doLazySingleSwap(final TspTour solution, final int index1,
		...
		int city21 = solution.get(beforeIndex2);
		int city22 = solution.get(index2);
		...
		int oldDistance = func.distance(city11, city12)
				+ func.distance(city12, city13) + func.distance(city21, city22)
				+ func.distance(city22, city23);
		
		//distance (city11 -> city22 -> city13) + distance (city21 -> city12 -> city23)
		int newDistance = func.distance(city11, city22)
				+ func.distance(city22, city13) + func.distance(city21, city12)
